                ...
                <div class="d-flex justify-content-center align-items-center" style="flex-wrap: nowrap; margin: 0 -15px;">
                    <div class="d-md-none text-center">
                        <div class="emoticon-background">
                            <img src="{{ Auth::check() && Auth::user()->jenis_kelamin === 'Cewek' ? asset('logo/netral1.png') : asset('logo/netral.png') }}" alt="Netral" class="mood-emoticon emoticon-clickable" style="width: 45px; height: 45px; transition: transform 0.2s ease; display: block;" onclick="this.style.transform='scale(1.2)'; setTimeout(() => this.style.transform='scale(1)', 300);">
                        </div>
                    </div>
                    ...
                    <div class="d-md-none text-center">
                        <div class="emoticon-background">
                            <img src="{{ Auth::check() && Auth::user()->jenis_kelamin === 'Cewek' ? asset('logo/senyum1.png') : asset('logo/senyum.png') }}" alt="Senyum" class="mood-emoticon emoticon-clickable" style="width: 45px; height: 45px; transition: transform 0.2s ease; display: block;" onclick="this.style.transform='scale(1.2)'; setTimeout(() => this.style.transform='scale(1)', 300);">
                        </div>
                    </div>
                    <div class="d-none d-md-block text-center">
                        <div class="emoticon-background">
                    ...
                    <div class="d-md-none text-center">
                        <div class="emoticon-background">
                            <img src="{{ Auth::check() && Auth::user()->jenis_kelamin === 'Cewek' ? asset('logo/sedih1.png') : asset('logo/sedih.png') }}" alt="Sedih" class="mood-emoticon emoticon-clickable" style="width: 45px; height: 45px; transition: transform 0.2s ease; display: block;" onclick="this.style.transform='scale(1.2)'; setTimeout(() => this.style.transform='scale(1)', 300);">
                        </div>
                    </div>
                    <div class="d-none d-md-block text-center">
                        <div class="emoticon-background">
                    ...
                    <div class="d-md-none text-center">
                        <div class="emoticon-background">
                            <img src="{{ Auth::check() && Auth::user()->jenis_kelamin === 'Cewek' ? asset('logo/lelah1.png') : asset('logo/lelah.png') }}" alt="lelah" class="mood-emoticon emoticon-clickable" style="width: 45px; height: 45px; transition: transform 0.2s ease; display: block;" onclick="this.style.transform='scale(1.2)'; setTimeout(() => this.style.transform='scale(1)', 300);">
                        </div>
                    </div>
                    <div class="d-none d-md-block text-center">
                        <div class="emoticon-background">
                    ...
                    <div class="d-md-none text-center">
                        <div class="emoticon-background">
                            <img src="{{ Auth::check() && Auth::user()->jenis_kelamin === 'Cewek' ? asset('logo/marah1.png') : asset('logo/marah.png') }}" alt="Marah" class="mood-emoticon emoticon-clickable" style="width: 45px; height: 45px; transition: transform 0.2s ease; display: block;" onclick="this.style.transform='scale(1.2)'; setTimeout(() => this.style.transform='scale(1)', 300);">
                        </div>
                    </div>
                    <div class="d-none d-md-block text-center">
                        <div class="emoticon-background">
