            ...
            @foreach($records as $record)
                <div class="record-item">
                    <div class="record-left">
                        @if(Auth::user()->avatar)
                            <img src="{{ Auth::user()->avatar }}" alt="Avatar" class="record-avatar">
                        @endif
                            ...
                            @else
                                <li class="page-item" style="display: inline-block; margin: 0 2px;">
                                    <a class="page-link" href="{{ $url }}" 
                                       style="border-radius: 8px; background-color: #ffffff; border: 1px solid #d98695; color: #82272c; padding: 8px 12px; text-decoration: none; display: block;">{{ $page }}</a>
                                </li>
                            @endif
                        @endforeach
