...
Route::post('/notif/push/cleanup', [App\Http\Controllers\NotificationController::class, 'cleanupPushSubscriptions'])->middleware(['auth', 'verified'])->name('notif.push.cleanup');
